...
class OpenAIClient:
    ...
    def answer_question(self, question: str, context: str) -> str:
        instructions = (
            ...
            "A romanized reading, Latin-script spelling, or obvious spelling variant of the SAME entity counts as mentioning "
            "the subject — treat them as identical. For example エスライド = S-RIDE = S.RIDE = sride; "
            "マネーフォワード = MoneyForward. This applies ONLY to spelling/transliteration of the same named entity, "
            "never to merely related or different topics.\n"
            "Examples:\n"
